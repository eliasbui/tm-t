...
export const BANK_NUMBER = /(^(9704|62|81|3528|3529|51|52|53|54|55|4|34|37)[0-9]*$)|(^35[3-8][0-9]*$)/;
...
export const SIGNATURE_KEY = 'ite@ecommerceServive+signature';
export const MY_KEY = 'ite@abcdEcommerce';
